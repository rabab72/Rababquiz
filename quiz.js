const quizArr = [{
    ...
    {
        id: 9,
        question: "What is the correct way to declare a variable using the let keyword?",
        options: {
    ...
    {
        id: 19,
        question: "What is the correct way to check if a variable is a number in javascript?",
        options: {
    ...
    {
        id: 20,
        question: "What is the correct way to check if a variable is an object in javascript?",
        options: {
